...
//     if (confirm("Do you want to add this job?")) {
//       await axios.post("http://localhost:3000/jobs", data);
//       alert("Job added successfully");
...
//   const [heerror, setheerror] = useState("");
...
//           {/* Header */}
//           <div className="d-flex justify-content-between align-items-center mb-4">
//             <h2 className="fw-bold text-primary m-0">Add Job Details</h2>

//             <NavLink to="/" className="btn btn-outline-primary rounded-3">
//               See All Jobs
//             </NavLink>
//           </div>
